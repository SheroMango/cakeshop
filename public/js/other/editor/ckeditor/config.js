...
CKEDITOR.editorConfig = function( config )
{
	...
	config.filebrowserBrowseUrl = 'public/js/other/editor/ckfinder/ckfinder.html'; 
	config.filebrowserImageBrowseUrl = 'public/js/other/editor/ckfinder/ckfinder.html?type=Images';

	config.filebrowserFlashBrowseUrl  = 'public/js/other/editor/ckfinder/ckfinder.html?type=Flash';

	config.filebrowserUploadUrl = 'public/js/other/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';

	config.filebrowserImageUploadUrl = 'public/js/other/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';

	config.filebrowserFlashUploadUrl  = 'public/js/other/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash';
